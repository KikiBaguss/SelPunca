                ...
                <table class="table tabel-hover table-striped table-bordered">
                    <thead class="thead-dark">
                        <tr>
                            ...
                            <th scope="col" width="15%">No Regulasi</th>
                            <th scope="col" width="15%">File Regulasi</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            while ($row = $result->fetch_assoc()) {
                                ...
                                echo "<td>" . $row['no_regulasi'] . "</td>";
                                echo "<td class='text-center'><a href='" . $row["file_regulasi"] . "' target='_blank'>" . "lihat" . "</a></td>";
                                echo "</tr>";
                                $no++;
                            }
                        } else {
