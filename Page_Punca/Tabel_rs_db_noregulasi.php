...
<body>
                ...
                <div class="col-12">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb" style="margin-bottom:20px ;">
                            ...
                            <li class="breadcrumb-item"><a href="sel_punca2.html"><i aria-hidden="true"></i> Sel Punca</a></li>
    ...
    <div class="container" style="margin-top: 0%;">
        <div class="card shadow-sm" style="border-radius: 5px">
            ...
            $sqlrs = "SELECT nama_rs, provinsi, kab_kota, no_regulasi, file_regulasi FROM daftarrs_selpunca";
            $result1 = $conn->query($sqlrs);
                ...
                <table class="table tabel-hover table-striped table-bordered">
                    <thead class="thead-dark">
                        <tr>
                            ...
                            <th scope="col" width="55%">Rumah Sakit
                            </th>
                            <th scope="col" width="20%">Provinsi</th>
                            <th scope="col" width="20%">Kota/Kabupaten</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php
                        $sql = "SELECT nama_rs, provinsi, kab_kota FROM daftarrs_selpunca";
                    ...
                    <table class="table tabel-hover table-striped table-bordered">
                        <thead class="thead-dark">
                            <tr>
                                ...
                                <th scope="col" width="55%">LABORATORIUM
                                </th>
                                <th scope="col" width="20%">Provinsi</th>
                                <th scope="col" width="20%">Kota/Kabupaten</th>
                            </tr>
                        ...
                        <tbody>
                            <?php
                            $sql = "SELECT nama_lab, provinsi, kab_kota FROM daftarklinik_selpunca";
                            $result = $conn->query($sql);
                    ...
                    <table class="table tabel-hover table-striped table-bordered">
                        <thead class="thead-dark">
                            <tr>
                                ...
                                <th scope="col" width="55%">Bank Sel Punca
                                </th>
                                <th scope="col" width="20%">Provinsi</th>
                                <th scope="col" width="20%">Kota/Kabupaten</th>
                            </tr>
                        ...
                        <tbody>
                            <?php
                            $sql = "SELECT nama_banksel, provinsi, kota_kab FROM daftarbanksel_selpunca";
                            $result = $conn->query($sql);
